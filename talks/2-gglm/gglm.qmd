...
I believe that **learning to code** while learning to statistics  
...
Provide students with the **tools to learn code** that has both a
...
You ask your students to fit a linear regression model to predict penguin bill length by their body mass and sex. 
...
- If you're a camp(R), programming should not be **tool that enhances understanding**, not a barrier to extracting knowledge from data. 
